...
def attack(char_name: str, char_class: str) -> str:
    """Расчитывает наносимый удар в зависимости от класса героя."""
...
def defence(char_name: str, char_class: str) -> str:
    """Блокировака урона при атаке в зависимости от класса героя."""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """Расчитывает специальные умения в завимисости от класса героя."""
    if char_class == 'warrior':
        return (f'{char_name}'
...
def start_training(char_name: str, char_class: str) -> str:
    """Входные характеристики героя и возможности тренировки."""
    if char_class == 'warrior':
